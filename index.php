...
.style9 {font-size: 95%; font-weight: bold; color: #00AAD4; font-family: Verdana, Arial, Helvetica, sans-serif; }
-->
</style>
</head>
<body>
<div id="wrapper">
  ...
  <div id="content">
    <h2><span style="color:#003300"> Welcome to Artease Clothings</span></h2>
    <p align="justify"><span class="style8"></span>Welcome to Artease Clothing website. Here you can buy various cloth products such as Jeans, T-Shirts, Shirts, trousers, of various well known brands. Customer has to just register on this website and then he or she can buy various cloth products online. Y0u need not to go to shopping mall.</p>
